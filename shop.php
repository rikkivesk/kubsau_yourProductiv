...
<body>
    <div class="container">
        <?php
        /*
         * циклом будет выводиться блок с ссылкой
         * на название категории товара
         * при нажатии на категорию будет произведен переход
         * на другую страницу где будет выводиться сам товар
         * исключительно той категории которую нужно будет вывести
         */
        $result = mysqli_query($connect, "SELECT id, name FROM `shop_category`");
